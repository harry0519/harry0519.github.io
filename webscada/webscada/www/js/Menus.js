 ...
 * Sets the default font size.
 */
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'data','arrange', 'extras', 'help'];
...
Menus.prototype.init = function()
{
	...
	this.put('data', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['dataview', '-', 'rotate', 'move','blink','visible','color','zoom','-','simulation']);
	})));
